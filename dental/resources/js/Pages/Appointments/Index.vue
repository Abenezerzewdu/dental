    ...
    <div class="p-8 max-w-5xl mx-auto text-[#2C3E50]">
        ...
        >
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-[#E5F3F3] text-[#2C3E50] uppercase text-sm">
                        <th class="p-3 border-b border-[#A4D6E1]">Patient</th>
                        <th class="p-3 border-b border-[#A4D6E1]">Date</th>
                        <th class="p-3 border-b border-[#A4D6E1]">Service</th>
                        <th class="p-3 border-b border-[#A4D6E1]">Status</th>
                        <th class="p-3 border-b border-[#A4D6E1] text-center">
                            Actions
                        </th>
                    </tr>
                </thead>
